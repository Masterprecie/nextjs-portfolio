...
const Hero = () => {
  return (
    <div className=" pb-36 pt-36 mb-[250px]">
      <div>
        <Spotlight
      ...
      >
        {/* grid Radial gradient for the container to give a faded look */}
        ...
        <div className="flex justify-center relative my-20 z-10">
          <div className="max-w-[89vw] md:max-w-2xl lg:max-w-[60vw] flex-col items-center justify-center">
            ...
            <p className="text-center md:tracking-wider mb-4 text-sm md:text-lg lg:text-2xl">
              {" "}
              Hi, I&lsquo;m Precious, a Next.js Developer based in Nigeria
            </p>
